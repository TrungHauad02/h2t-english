            ...
            <Card
                sx={{
                    ...
                    boxShadow: hooks.hover
                        ? `0 20px 30px -10px ${isDarkMode ? "rgba(0,0,0,0.5)" : "rgba(15, 118, 110, 0.2)"
                        }`
                        : `0 10px 15px -5px ${isDarkMode ? "rgba(0,0,0,0.3)" : "rgba(15, 118, 110, 0.1)"
                        }`,
                    transform: `translateY(${hooks.hover ? "-8px" : "0px"
                        }) scale(${hooks.cardScale})`,
