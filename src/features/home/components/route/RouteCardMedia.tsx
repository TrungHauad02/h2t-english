        ...
        >
            ...
            <Box
                sx={{
                    ...
                    right: 0,
                    height: "50%",
                    background: `linear-gradient(transparent, ${isDarkMode ? colors.gray900 + "e6" : colors.gray800 + "99"
                        })`,
            ...
            <Chip
                ...
                sx={{
                    ...
                    bottom: 10,
                    right: 10,
                    backgroundColor: isDarkMode ? `${colors.teal700}cc` : `${colors.teal100}cc`,
                    ...
                    boxShadow: hover
                        ? `0 4px 8px ${isDarkMode ? "rgba(0,0,0,0.3)" : "rgba(13, 148, 136, 0.2)"
                        }`
                        : "none",
                }}
            />
