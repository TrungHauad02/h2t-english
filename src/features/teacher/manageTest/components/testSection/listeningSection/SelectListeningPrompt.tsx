...
interface SelectListeningPromptProps {
  isEditMode: boolean;
  handleAddListening: () => void;
}

export default function SelectListeningPrompt({
  isEditMode,
  handleAddListening
}: SelectListeningPromptProps) {
  ...
  return (
    ...
    >
      ...
      >
        Select or Add a Listening Passage
      </Typography>
      ...
      >
        Select a listening passage from the left panel or add a new one to test students' listening comprehension skills.
      </Typography>
      ...
      >
        ...
        <Typography variant="body2">
          Audio files support MP3, WAV, and OGG formats
        </Typography>
      </Box>
    </Box>
  );
