...
import useHistoryReadingTest from "../../hooks/useHistoryReadingTest";
...
export default function HistoryReadingTest({
  ...
  const handleSetQuestionRef = (id: number, el: HTMLDivElement | null) => {
          ...
          <Stack spacing={4}>
            {readingItems.map((item, idx) => (
              ...
              >
                ...
                <Box sx={{ mb: 3 }}>
                  <WEDocumentViewer fileUrl={item.file} />
                </Box>
