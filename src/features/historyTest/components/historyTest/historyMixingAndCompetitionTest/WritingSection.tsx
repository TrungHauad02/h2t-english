...
export default function WritingSection({
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        setLoading(true);
        const res = await testWritingService.getByIdsAndStatus(testItemIds, true);
                                    ...
                                    <Box sx={{ 
                                      ...
                                      <Box sx={{ 
                                        ...
                                        <Box sx={{ flex: 1 }}>
                                          ...
                                          >
                                            Writing section total: {totalMaxScore.toFixed(1)} points
                                          </Typography>
                                          <Typography 
                                            variant="body2" 
                                            sx={{ 
                                      ...
                                      >
                                        This score contributes to your overall writing assessment.
                                      </Typography>
                                    </Box>
                                  </Box>
                                </>
