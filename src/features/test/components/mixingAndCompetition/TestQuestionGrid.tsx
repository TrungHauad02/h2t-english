...
const TestQuestionGrid: React.FC<TestQuestionGridProps> = ({
  ...
  const getProgressColor = () => {
    if (stats.percentage >= 90)
      return isDarkMode ? color.green600 : color.green500;
    if (stats.percentage >= 70)
      return isDarkMode ? color.emerald600 : color.emerald500;
    if (stats.percentage >= 50)
      return isDarkMode ? color.teal600 : color.teal500;
    if (stats.percentage >= 30)
      return isDarkMode ? color.teal700 : color.teal600;
                          ...
                          switch (section) {
                            ...
                            case "WRITING":
                              return isDarkMode
                                ...
                                : color.green600;
                            default:
                              return isDarkMode ? color.gray300 : color.gray600;
                          }
                        })(),
                      }}
                    />
