...
export default function ReadingTest({ testReadings, submitTest,test }: ReadingTestProps) {
  ...
  const [readingExpandedMap, setReadingExpandedMap] = useState<Record<number, boolean>>({});
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <Box sx={{ 
                    ...
                    <Box sx={{
                      ...
                      height: '40px',
                      borderRadius: '50%',
                      backgroundColor: isDarkMode ? 'rgba(110, 231, 183, 0.15)' : 'rgba(16, 185, 129, 0.15)',
                    }}>
                      <MenuBookIcon 
                        sx={{ 
                  ...
                  <Tooltip title={readingExpandedMap[index] ? "Collapse" : "Expand"}>
                    <IconButton 
                      ...
                      sx={{ 
                        ...
                        transition: 'all 0.3s ease',
                        transform: readingExpandedMap[index] ? 'rotate(0deg)' : 'rotate(180deg)'
                      }}
                    >
                  ...
                  <Box 
                    sx={{ 
                      ...
                      '&::-webkit-scrollbar-thumb': {
                        ...
                        borderRadius: '4px',
                        '&:hover': {
                          background: isDarkMode ? color.gray500 : color.gray500,
                        },
                      },
                    }}
                  >
                ...
                <Box sx={{ 
                  ...
                  <Box sx={{ 
                    ...
                    <Box sx={{
                      ...
                      height: '40px',
                      borderRadius: '50%',
                      backgroundColor: isDarkMode ? 'rgba(94, 234, 212, 0.15)' : 'rgba(20, 184, 166, 0.15)',
                    }}>
                      <QuizIcon 
                        sx={{ 
