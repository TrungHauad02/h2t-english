...
export default function SendOTPForm({ onOtpValidated }: { onOtpValidated?: () => void }) {
    ...
    return (
        ...
        >
            ...
            >
                {useSendOTP.isCounting ? `Resend OTP (${useSendOTP.countdown}s)` : "Send OTP"}
            </Button>
