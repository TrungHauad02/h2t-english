...
export const ViewModeContent = ({ data }: ViewModeContentProps) => {
  ...
  return (
    <CardContent
      sx={{ pb: 4, pt: 10, position: "relative", maxwidth: { md: "1400px" } }}
    >
      <Box
        sx={{
          position: "absolute",
        ...
        <Grid item xs={12} md={6}>
          <Stack spacing={3}>
            <Box>
              <Typography
                variant="h5"
                sx={{ color: secondaryTextColor, mb: 1 }}
              >
                Contact Information
              </Typography>
              <Stack spacing={2}>
            ...
            <Box>
              ...
              <Stack spacing={2}>
                ...
                >
                  <Typography
                    variant="body2"
                    sx={{ color: secondaryTextColor, fontWeight: "medium" }}
                  >
                    Account Status:
                    <Box
                      component="span"
                      sx={{
                        ml: 1,
                        color: data?.status ? color.emerald600 : color.red600,
                        fontWeight: "bold",
                      }}
                    >
