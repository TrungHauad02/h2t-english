...
export default function TestItem({ toeic }: { toeic: Toeic }) {
  ...
  const getTypeGradient = () => {
    return isDarkMode
      ? `linear-gradient(135deg, ${color.teal900}, ${color.teal700})`
        ...
        >
          ...
          >
            ...
            <Box>
              ...
              >
                {toeic?.title.length > 35
                  ? `${toeic?.title.substring(0, 32)}...`
                  : toeic?.title}
              </Typography>
            </Box>
          </Box>
